...
class ExampAdmin(admin.ModelAdmin):
    list_display = ('name', 'id', 'lesson', 'main_examp',
...
class QuestionAdmin(admin.ModelAdmin):
    list_display = ('question_text', 'id', 'subcategory',
                    'free_subcategory', 'examp', 'status', 'created_at')
    list_filter = ('subcategory', 'free_subcategory',
                   'examp', 'status', 'created_at')
    list_editable = ('status',)
...
class AnswerAdmin(admin.ModelAdmin):
    list_display = ('answer_text', 'id', 'question',
                    'true_answer', 'status', 'created_at')
...
class ResultAdmin(admin.ModelAdmin):
    list_display = ('student', 'subcategory', 'examp',
                    'ball', 'coin', 'status', 'created_at')
