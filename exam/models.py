...
class FreeSubCategory(models.Model):
    ...
    category = models.ForeignKey(
        FreeCategory, on_delete=models.CASCADE, related_name='free_subcategories')
    about = models.TextField(blank=True, null=True, verbose_name="Batafsil")
    examp_type = models.CharField(
        max_length=20, choices=EXAMP_TYPE, default='always', verbose_name="Imtihon turi")
...
class FreeResult(models.Model):
    subcategory = models.ForeignKey(
        FreeSubCategory, on_delete=models.CASCADE, related_name="free_results", blank=True, null=True)
    slug = AutoSlugField(
        (u'slug'), populate_from=slug_funckion_for_free_result_model, unique=True)
...
class Examp(models.Model):
    ...
    lesson = models.ForeignKey(
        Lessons, on_delete=models.CASCADE, related_name='examp')
...
class Question(models.Model):
    ...
    subcategory = models.ForeignKey(
        SubCategory, on_delete=models.CASCADE, related_name='questions', blank=True, null=True)
    free_subcategory = models.ForeignKey(
        FreeSubCategory, on_delete=models.CASCADE, related_name='questions', blank=True, null=True)
    examp = models.ForeignKey(
        Examp, on_delete=models.CASCADE, related_name='questions', blank=True, null=True)
    question_text = models.CharField(max_length=123)
    slug = AutoSlugField(
        (u'slug'), populate_from=slug_funckion_for_question_model, unique=True)
...
class Answer(models.Model):
    ...
    slug = AutoSlugField(
        (u'slug'), populate_from=slug_funckion_for_answer_model, unique=True)
...
class Result(models.Model):
    ...
    slug = AutoSlugField(
        (u'slug'), populate_from=slug_funckion_for_result_model, unique=True)
    subcategory = models.ForeignKey(
        SubCategory, on_delete=models.CASCADE, related_name="results", blank=True, null=True)
    examp = models.ForeignKey(
        Examp, on_delete=models.CASCADE, related_name="results", blank=True, null=True)
    ball = models.PositiveIntegerField(default=0, blank=True, null=True)
